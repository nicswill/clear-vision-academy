      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#0a1628] to-[#1e3a5f] rounded-2xl p-8 border-2 border-[#d4af37] shadow-xl mb-12">
            ...
            <h1 className="text-4xl font-bold text-white mb-4">Clear Vision Devotional Track</h1>
            <p className="text-xl text-gray-200 mb-6">
              Faith-integrated leadership devotionals combining scripture, reflection, and journaling for spiritual wellness.
            </p>

            <div className="flex flex-wrap gap-3 mb-6">
              <span className="bg-[#d4af37] text-[#0a1628] px-4 py-2 rounded-full text-sm font-bold">30 Days</span>
              <span className="bg-[#d4af37] text-[#0a1628] px-4 py-2 rounded-full text-sm font-bold">Self-Paced</span>
              <span className="bg-[#d4af37] text-[#0a1628] px-4 py-2 rounded-full text-sm font-bold">Spiritual Growth</span>
            </div>
          ...
          <div className="bg-white rounded-xl p-8 border-2 border-[#d4af37]/30 shadow-md mb-12">
            <h2 className="text-2xl font-bold mb-6 text-[#d4af37]">Track Overview</h2>
            <p className="text-gray-700 mb-4">
              The Clear Vision Devotional Track integrates scripture and faith practices with leadership development.
              Each day includes a scripture passage, leadership reflection, and journaling prompts to deepen your
              spiritual wellness and leadership clarity.
            </p>
            <p className="text-gray-700">
              Perfect for leaders who want to align their faith with their leadership practice and develop a consistent
              spiritual rhythm.
            </p>
          </div>
...
export default CourseDevotional;
