...
function CoursePermissionToPause() {
  return (
      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#0a1628] to-[#1e3a5f] rounded-2xl p-8 border-2 border-[#d4af37] shadow-xl mb-12">
            <Clock className="w-16 h-16 text-[#d4af37] mb-4" />
            <h1 className="text-4xl font-bold text-white mb-4">Permission to Pause™</h1>
            <p className="text-xl text-gray-200 mb-6">
              Prevent burnout and lead from rest. Discover the power of strategic pausing and sustainable leadership rhythms.
            </p>

            <div className="flex flex-wrap gap-3 mb-6">
              <span className="bg-[#d4af37] text-[#0a1628] px-4 py-2 rounded-full text-sm font-bold">5 Modules</span>
              <span className="bg-[#d4af37] text-[#0a1628] px-4 py-2 rounded-full text-sm font-bold">5 Weeks</span>
              <span className="bg-[#d4af37] text-[#0a1628] px-4 py-2 rounded-full text-sm font-bold">Sustainability</span>
            </div>
            ...
            <div className="border-t border-[#d4af37]/30 pt-6">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  'Power of strategic pause',
                  'Physical pause practices',
          ...
          <div className="bg-white rounded-xl p-8 border-2 border-[#d4af37]/30 shadow-md mb-12">
            ...
            <p className="text-gray-700 mb-4">
              Permission to Pause™ is designed for leaders who are exhausted, overwhelmed, or approaching burnout. This course
              gives you permission to reset, teaches you how to incorporate strategic pausing into your leadership practice,
              and helps you build sustainable rhythms.
            </p>
            <p className="text-gray-700">
              Learn to lead from rest, not exhaustion. Discover how pausing actually increases productivity, clarity, and impact.
            </p>
          </div>
...
export default CoursePermissionToPause;
